...
<div class="container mt-4">
	<form method="post" class="woocommerce-ResetPassword lost_reset_password">
		...
		<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
			...
			<input type="password" class="woocommerce-Input woocommerce-Input--text input-text p-2 bg-white border border-1" name="password_1" id="password_1" autocomplete="new-password" required aria-required="true" />
		</p>
		<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
			...
			<input type="password" class="woocommerce-Input woocommerce-Input--text p-2 bg-white border border-1 input-text" name="password_2" id="password_2" autocomplete="new-password" required aria-required="true" />
		</p>
