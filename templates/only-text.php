 ...
 */
?>
<main id="text-page" class="block-page <?php echo esc_attr($page_class); ?>">
    <div class="container" style="max-width: 870px;">
        <?php // Check if there's content to display
        if (have_posts()) :
            while (have_posts()) :
                the_post();
                the_content();
...
<?php
    $page_bottom_spacing = get_field('bottom_spacing') ? 'pb-5' : '';

    echo '<div class="' . $page_bottom_spacing . '"></div>';
